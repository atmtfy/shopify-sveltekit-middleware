...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-ca0d0dfa.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-ca0d0dfa.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
async function tryCallback(callback, params) {
    ...
    if (typeof callback == 'function') {
        try {
            const response = await callback(params ? params : null);
            console.log("logging callback response:");
...
async function setup(config) {
    ...
    console.log(value);
    if (value[0]) {
        Logger('Sample memory item: ' + value[0], 'info');
    }
}
...
//# sourceMappingURL=middleware-ca0d0dfa.js.map
