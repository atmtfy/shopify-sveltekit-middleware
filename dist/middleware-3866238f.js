...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-3866238f.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-3866238f.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
function Logger(msg, level) {
    if (typeof msg != "string") {
        ...
        if (level == "error") {
            ...
            switch (level) {
                case "info":
                    console.log(bold(green('Shopify Middleware:')) + " " + green(msg));
                    break;
                case "warning":
                    console.log(bold(yellow('Shopify Middleware Warning:')) + " " + yellow(msg));
                    break;
            }
        }
    }
...
//# sourceMappingURL=middleware-3866238f.js.map
