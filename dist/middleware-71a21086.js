...
import fs from 'fs';
import require$$0$1, { dirname } from 'path';
...
var _crypto$2 = _interopRequireDefault$b(require$$1$1);
...
var _crypto$1 = _interopRequireDefault$5(require$$1$1);
...
var _crypto = _interopRequireDefault$2(require$$1$1);
...
var crypto_1$4 = tslib_1$j.__importDefault(require$$1$1);
function nonce() {
    var length = 15;
...
var crypto_1$3 = tslib_1$i.__importDefault(require$$1$1);
...
var crypto_1$2 = tslib_1$h.__importDefault(require$$1$1);
...
/*jshint node:true */
var Buffer$6 = require$$0$2.Buffer; // browserify
...
var crypto_1$1 = tslib_1$d.__importDefault(require$$1$1);
var fs_1 = tslib_1$d.__importDefault(fs);
...
async function loadConfig(options = null) {
    let validated = false;
    const config_file = require$$0$1.join(process.cwd(), 'shopify.config.js');
    if (options == null || typeof options != 'object') {
        if (!fs.existsSync('shopify.config.js')) {
            ...
            const config = await import(url$1.pathToFileURL(config_file).href);
...
export { buildMiddleware as b };
//# sourceMappingURL=middleware-71a21086.js.map
