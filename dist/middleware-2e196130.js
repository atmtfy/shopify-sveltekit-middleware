...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-2e196130.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-2e196130.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
function convertToSession(s) {
    let toReturn = new session$1.Session(s.id, s.shop, s.state, s.isOnline);
    return toReturn;
}
class Utils {
    config;
...
//# sourceMappingURL=middleware-2e196130.js.map
