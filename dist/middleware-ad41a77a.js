...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-ad41a77a.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-ad41a77a.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
class Utils {
    ...
    checkDevIntercept(shop) {
        ...
        if (isDev() && this.config.dev) {
            ...
            console.log(`Should check needle == host: ${needle} == ${shop} == ${needle == shop}`);
...
//# sourceMappingURL=middleware-ad41a77a.js.map
