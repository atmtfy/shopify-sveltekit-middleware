...
var cleanup__default = /*#__PURE__*/_interopDefaultLegacy(cleanup);
...
function isDev() {
    ...
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-c4470875.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-c4470875.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
var ShopifyErrors$c = tslib_1$j.__importStar(error);
var memory_1 = memory;
...
var ShopifyErrors$b = tslib_1$h.__importStar(error);
/**
...
var ShopifyErrors$a = tslib_1$g.__importStar(error);
...
var ShopifyErrors$9 = tslib_1$f.__importStar(error);
...
var ShopifyErrors$8 = tslib_1$e.__importStar(error);
...
//# sourceMappingURL=middleware-c4470875.js.map
