...
function isDev() {
    console.log('Checking if dev!');
    console.log('process.env.NODE_ENV');
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-3b2fef23.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-3b2fef23.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
    else if (process && process.env && process.env.NODE_ENV == 'DEVELOPMENT') {
        return true;
    }
}
...
function findHook(options, hook, args = null) {
...
async function removeShopFromMemory(shopName, callback) {
    Logger(`Removing shop ${shopName} from memory`, "info");
    if (usingMemory()) {
        shops.update(val => {
            let final = val;
...
let ACCESS_TOKENS = {};
async function provideToken(shop, options) {
    if (shop in ACCESS_TOKENS) {
        return { shop, accessToken: ACCESS_TOKENS[shop] };
    }
    else {
        if (options.dev) {
            let needle = options.dev.host ? options.dev.host : 'localhost';
            if (shop == needle) {
                if ('shop' in options.dev && 'accessToken' in options.dev) {
                    return { shop: options.dev.shop, accessToken: options.dev.accessToken };
                }
            }
        }
        try {
            const session = await findShopInMemory(shop, findHook(options, 'shop.find', shop));
            if (session) {
...
error$1.PrivateAppError = error$1.SessionStorageError = error$1.UnsupportedClientType = error$1.MissingRequiredArgument = error$1.InvalidWebhookError = error$1.InvalidSession = error$1.CookieNotFound = error$1.SessionNotFound = error$1.InvalidOAuthError = error$1.UninitializedContextError = error$1.HttpThrottlingError = error$1.HttpInternalError = error$1.HttpRetriableError = error$1.HttpResponseError = error$1.HttpMaxRetriesError = error$1.HttpRequestError = error$1.SafeCompareError = error$1.MissingJwtTokenError = error$1.InvalidJwtError = error$1.InvalidShopError = error$1.InvalidHmacError = error$1.ShopifyError = void 0;
var tslib_1$m = require$$0;
var ShopifyError = /** @class */ (function (_super) {
    tslib_1$m.__extends(ShopifyError, _super);
    function ShopifyError() {
        ...
        var _this = _super.apply(this, tslib_1$m.__spread(args)) || this;
        Object.setPrototypeOf(_this, _newTarget.prototype);
        return _this;
    }
    return ShopifyError;
}(Error));
error$1.ShopifyError = ShopifyError;
var InvalidHmacError = /** @class */ (function (_super) {
    tslib_1$m.__extends(InvalidHmacError, _super);
    function InvalidHmacError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidHmacError;
}(ShopifyError));
error$1.InvalidHmacError = InvalidHmacError;
var InvalidShopError = /** @class */ (function (_super) {
    tslib_1$m.__extends(InvalidShopError, _super);
    function InvalidShopError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidShopError;
}(ShopifyError));
error$1.InvalidShopError = InvalidShopError;
var InvalidJwtError = /** @class */ (function (_super) {
    tslib_1$m.__extends(InvalidJwtError, _super);
    function InvalidJwtError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidJwtError;
}(ShopifyError));
error$1.InvalidJwtError = InvalidJwtError;
var MissingJwtTokenError = /** @class */ (function (_super) {
    tslib_1$m.__extends(MissingJwtTokenError, _super);
    function MissingJwtTokenError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return MissingJwtTokenError;
}(ShopifyError));
error$1.MissingJwtTokenError = MissingJwtTokenError;
var SafeCompareError = /** @class */ (function (_super) {
    tslib_1$m.__extends(SafeCompareError, _super);
    function SafeCompareError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return SafeCompareError;
}(ShopifyError));
error$1.SafeCompareError = SafeCompareError;
var UninitializedContextError = /** @class */ (function (_super) {
    tslib_1$m.__extends(UninitializedContextError, _super);
    function UninitializedContextError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return UninitializedContextError;
}(ShopifyError));
error$1.UninitializedContextError = UninitializedContextError;
var PrivateAppError = /** @class */ (function (_super) {
    tslib_1$m.__extends(PrivateAppError, _super);
    function PrivateAppError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return PrivateAppError;
}(ShopifyError));
error$1.PrivateAppError = PrivateAppError;
var HttpRequestError = /** @class */ (function (_super) {
    tslib_1$m.__extends(HttpRequestError, _super);
    function HttpRequestError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpRequestError;
}(ShopifyError));
error$1.HttpRequestError = HttpRequestError;
var HttpMaxRetriesError = /** @class */ (function (_super) {
    tslib_1$m.__extends(HttpMaxRetriesError, _super);
    function HttpMaxRetriesError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpMaxRetriesError;
}(ShopifyError));
error$1.HttpMaxRetriesError = HttpMaxRetriesError;
var HttpResponseError = /** @class */ (function (_super) {
    tslib_1$m.__extends(HttpResponseError, _super);
...
error$1.HttpResponseError = HttpResponseError;
var HttpRetriableError = /** @class */ (function (_super) {
    tslib_1$m.__extends(HttpRetriableError, _super);
    function HttpRetriableError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpRetriableError;
}(ShopifyError));
error$1.HttpRetriableError = HttpRetriableError;
var HttpInternalError = /** @class */ (function (_super) {
    tslib_1$m.__extends(HttpInternalError, _super);
    function HttpInternalError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpInternalError;
}(HttpRetriableError));
error$1.HttpInternalError = HttpInternalError;
var HttpThrottlingError = /** @class */ (function (_super) {
    tslib_1$m.__extends(HttpThrottlingError, _super);
...
error$1.HttpThrottlingError = HttpThrottlingError;
var InvalidOAuthError = /** @class */ (function (_super) {
    tslib_1$m.__extends(InvalidOAuthError, _super);
    function InvalidOAuthError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidOAuthError;
}(ShopifyError));
error$1.InvalidOAuthError = InvalidOAuthError;
var SessionNotFound = /** @class */ (function (_super) {
    tslib_1$m.__extends(SessionNotFound, _super);
    function SessionNotFound() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return SessionNotFound;
}(ShopifyError));
error$1.SessionNotFound = SessionNotFound;
var CookieNotFound = /** @class */ (function (_super) {
    tslib_1$m.__extends(CookieNotFound, _super);
    function CookieNotFound() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return CookieNotFound;
}(ShopifyError));
error$1.CookieNotFound = CookieNotFound;
var InvalidSession = /** @class */ (function (_super) {
    tslib_1$m.__extends(InvalidSession, _super);
    function InvalidSession() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidSession;
}(ShopifyError));
error$1.InvalidSession = InvalidSession;
var InvalidWebhookError = /** @class */ (function (_super) {
    tslib_1$m.__extends(InvalidWebhookError, _super);
    function InvalidWebhookError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidWebhookError;
}(ShopifyError));
error$1.InvalidWebhookError = InvalidWebhookError;
var SessionStorageError = /** @class */ (function (_super) {
    tslib_1$m.__extends(SessionStorageError, _super);
    function SessionStorageError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return SessionStorageError;
}(ShopifyError));
error$1.SessionStorageError = SessionStorageError;
var MissingRequiredArgument = /** @class */ (function (_super) {
    tslib_1$m.__extends(MissingRequiredArgument, _super);
    function MissingRequiredArgument() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return MissingRequiredArgument;
}(ShopifyError));
error$1.MissingRequiredArgument = MissingRequiredArgument;
var UnsupportedClientType = /** @class */ (function (_super) {
    tslib_1$m.__extends(UnsupportedClientType, _super);
    function UnsupportedClientType() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return UnsupportedClientType;
}(ShopifyError));
error$1.UnsupportedClientType = UnsupportedClientType;
...
var MemorySessionStorage = /** @class */ (function () {
    ...
    MemorySessionStorage.prototype.storeSession = function (session) {
        return tslib_1$l.__awaiter(this, void 0, void 0, function () {
            return tslib_1$l.__generator(this, function (_a) {
...
var AuthScopes = /** @class */ (function () {
    function AuthScopes(scopes) {
        ...
        this.compressedScopes = new Set(tslib_1$k.__spread(scopeSet).filter(function (x) { return !impliedSet.has(x); }));
        this.expandedScopes = new Set(tslib_1$k.__spread(scopeSet, impliedSet));
    }
    ...
    AuthScopes.prototype.toArray = function () {
        return tslib_1$k.__spread(this.compressedScopes);
    };
...
var ShopifyErrors$c = tslib_1$j.__importStar(error$1);
var memory_1 = memory;
var base_types_1$5 = base_types;
var scopes_1 = scopes;
var Context = {
    API_KEY: '',
    API_SECRET_KEY: '',
...
var crypto_1$4 = tslib_1$i.__importDefault(require$$1__default["default"]);
function nonce() {
    var length = 15;
...
var crypto_1$3 = tslib_1$h.__importDefault(require$$1__default["default"]);
var ShopifyErrors$b = tslib_1$h.__importStar(error$1);
/**
...
var crypto_1$2 = tslib_1$g.__importDefault(require$$1__default["default"]);
var querystring_1$3 = tslib_1$g.__importDefault(querystring$1);
var ShopifyErrors$a = tslib_1$g.__importStar(error$1);
var context_1$f = context;
var safe_compare_1$2 = tslib_1$g.__importDefault(safeCompare$1);
function stringifyQuery(query) {
    ...
    return querystring_1$3.default.stringify(orderedObj);
}
...
function generateLocalHmac(_a) {
    ...
    var queryString = stringifyQuery(tslib_1$g.__assign({ code: code,
        timestamp: timestamp,
        state: state,
...
var jsonwebtoken_1 = tslib_1$f.__importDefault(jsonwebtoken);
var context_1$e = context;
var ShopifyErrors$9 = tslib_1$f.__importStar(error$1);
var shop_validator_1$3 = tslib_1$f.__importDefault(shopValidator);
/**
...
var ShopifyErrors$8 = tslib_1$e.__importStar(error$1);
var CustomSessionStorage = /** @class */ (function () {
    ...
    CustomSessionStorage.prototype.storeSession = function (session) {
        return tslib_1$e.__awaiter(this, void 0, void 0, function () {
            var error_1;
            return tslib_1$e.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 3:
                        if (result) {
                            if (result instanceof session_1$1.Session) {
                                ...
                                session = new session_1$1.Session(result.id);
                                session = tslib_1$e.__assign(tslib_1$e.__assign({}, session), result);
...
var punycode$2 = punycode$3.exports;
var util = util$1;
...
Url.prototype.parse = function(url, parseQueryString, slashesDenoteHost) {
  ...
  if (!hostlessProtocol[proto] &&
    ...
    if (!ipv6Hostname) {
      ...
      this.hostname = punycode$2.toASCII(this.hostname);
    }
...
version.SHOPIFY_API_LIBRARY_VERSION = '1.4.3';
...
var ShopifyErrors$7 = tslib_1$d.__importStar(error$1);
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        queryString = params.query
                            ? "?" + querystring_1$2.default.stringify(params.query)
                            : '';
...
var ShopifyErrors$6 = tslib_1$c.__importStar(error$1);
var ShopifyOAuth = {
            ...
            return tslib_1$c.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3:
                        if (!context_1$b.Context.IS_EMBEDDED_APP) return [3 /*break*/, 5];
                        ...
                        return [4 /*yield*/, context_1$b.Context.SESSION_STORAGE.storeSession(jwtSession)];
                    case 4:
                        _a.sent();
...
var base_types_1$4 = base_types;
var http_client_1$1 = http_client;
var ShopifyErrors$5 = tslib_1$b.__importStar(error$1);
var RestClient = /** @class */ (function (_super) {
    ...
    RestClient.prototype.request = function (params) {
        return tslib_1$b.__awaiter(this, void 0, void 0, function () {
            ...
            var _a, e_1, _b;
            return tslib_1$b.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        params.extraHeaders = tslib_1$b.__assign((_a = {}, _a[base_types_1$4.ShopifyHeader.AccessToken] = context_1$a.Context.IS_PRIVATE_APP
    ...
    RestClient.prototype.getRestPath = function (path) {
        return "/admin/api/" + context_1$a.Context.API_VERSION + "/" + path + ".json";
    };
...
var base_types_1$3 = base_types;
var http_client_1 = http_client;
var types_1$1 = types$9;
var ShopifyErrors$4 = tslib_1$a.__importStar(error$1);
...
var oauth_1$3 = oauth;
var ShopifyErrors$3 = tslib_1$8.__importStar(error$1);
/**
...
var ShopifyErrors$2 = tslib_1$4.__importStar(error$1);
...
function versionCompatible(referenceVersion, currentVersion) {
    ...
    if (currentVersion === base_types_1$1.ApiVersion.Unstable ||
        currentVersion === base_types_1$1.ApiVersion.Unversioned) {
        return true;
    }
...
var ShopifyErrors$1 = tslib_1$2.__importStar(error$1);
...
var graphql_client_1 = graphql_client;
var base_types_1 = base_types;
var utils_1 = tslib_1.__importDefault(utils);
var context_1 = context;
var ShopifyErrors = tslib_1.__importStar(error$1);
var types_1 = types$8;
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require$$0;
tslib_1.__exportStar(base_types, exports);
...
async function setupDeleteWebhook(shop, session) {
    const response = await dist$1.Shopify.Webhooks.Registry.register({
        shop,
...
const startAuth = async (url, request, response, callbackPath) => {
    ...
    try {
        const authRoute = await dist$1.Shopify.Auth.beginAuth(request, response, shop, callbackPath, false);
...
const handleCallback = async (url, request, response, options) => {
    ...
    try {
        await dist$1.Shopify.Auth.validateAuthCallback(request, response, params);
        const session = await dist$1.Shopify.Utils.loadCurrentSession(request, response, false);
        ...
        response.writeHead(302, { location: getFinalUrl(options, params), 'Shopify-Token': session.accessToken });
        response.end();
        return false;
    }
    catch (e) {
...
const handleDelete = async (url, request, response, options) => {
    await dist$1.Shopify.Utils.deleteCurrentSession(request, response);
...
function configureSessionStorage(options) {
    if (typeof options.sessionStorage == 'object') {
        if (options.sessionStorage.customSessionStorage) {
            ...
            return generateSessionStorageFromPath(options.sessionStorage.path);
        }
    }
    else if (typeof options.sessionStorage == 'string') {
        return generateSessionStorageFromPath(options.sessionStorage);
    }
    else {
        return undefined;
    }
...
function setupContext(options) {
    dist$1.Shopify.Context.initialize({
...
async function middleware (options) {
    ...
    const pathsToWatch = typeof config.auth == "string"
        ? { root: config.auth, callback: config.auth + '/callback', delete: config.auth + '/delete', token: '/_token' }
        : config.auth;
        ...
        if (req.url) {
            switch (url.pathname) {
                case pathsToWatch.root:
                    ...
                    break;
                case pathsToWatch.token:
                    const resp = await provideToken(url.hostname, options);
                    if (resp) {
...
//# sourceMappingURL=middleware-3b2fef23.js.map
