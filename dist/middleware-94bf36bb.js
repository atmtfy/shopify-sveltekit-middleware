...
async function loadConfig(options = null) {
    ...
    if (options == null || typeof options != 'object') {
        ...
        if (!fs__default["default"].existsSync('shopify.config.js')) {
            ...
            console.log(url.pathToFileURL(config_file).href);
            const config = await (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(url.pathToFileURL(config_file).href);
...
//# sourceMappingURL=middleware-94bf36bb.js.map
