...
var url__namespace = /*#__PURE__*/_interopNamespace(url$1);
...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-90f11786.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-90f11786.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
function preFsCheck(path) {
    try {
        if (fs__default["default"].existsSync(path)) {
        }
        else {
            fs__default["default"].mkdir(require$$0$1.dirname(path), { recursive: true }, function (err) {
                if (err)
                    return console.error(err);
                fs__default["default"].writeFile(path, '{}', () => { Logger("Generated session storage file at " + path, "info"); });
            });
        }
    }
    catch (e) {
...
error.PrivateAppError = error.SessionStorageError = error.UnsupportedClientType = error.MissingRequiredArgument = error.InvalidWebhookError = error.InvalidSession = error.CookieNotFound = error.SessionNotFound = error.InvalidOAuthError = error.UninitializedContextError = error.RestResourceRequestError = error.RestResourceError = error.HttpThrottlingError = error.HttpInternalError = error.HttpRetriableError = error.HttpResponseError = error.HttpMaxRetriesError = error.HttpRequestError = error.SafeCompareError = error.MissingJwtTokenError = error.InvalidJwtError = error.InvalidShopError = error.InvalidHmacError = error.ShopifyError = void 0;
var tslib_1$n = require$$0;
var ShopifyError = /** @class */ (function (_super) {
    tslib_1$n.__extends(ShopifyError, _super);
    function ShopifyError() {
        ...
        var _this = _super.apply(this, tslib_1$n.__spread(args)) || this;
        Object.setPrototypeOf(_this, _newTarget.prototype);
        return _this;
    }
    return ShopifyError;
}(Error));
error.ShopifyError = ShopifyError;
var InvalidHmacError = /** @class */ (function (_super) {
    tslib_1$n.__extends(InvalidHmacError, _super);
    function InvalidHmacError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidHmacError;
}(ShopifyError));
error.InvalidHmacError = InvalidHmacError;
var InvalidShopError = /** @class */ (function (_super) {
    tslib_1$n.__extends(InvalidShopError, _super);
    function InvalidShopError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidShopError;
}(ShopifyError));
error.InvalidShopError = InvalidShopError;
var InvalidJwtError = /** @class */ (function (_super) {
    tslib_1$n.__extends(InvalidJwtError, _super);
    function InvalidJwtError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidJwtError;
}(ShopifyError));
error.InvalidJwtError = InvalidJwtError;
var MissingJwtTokenError = /** @class */ (function (_super) {
    tslib_1$n.__extends(MissingJwtTokenError, _super);
    function MissingJwtTokenError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return MissingJwtTokenError;
}(ShopifyError));
error.MissingJwtTokenError = MissingJwtTokenError;
var SafeCompareError = /** @class */ (function (_super) {
    tslib_1$n.__extends(SafeCompareError, _super);
    function SafeCompareError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return SafeCompareError;
}(ShopifyError));
error.SafeCompareError = SafeCompareError;
var UninitializedContextError = /** @class */ (function (_super) {
    tslib_1$n.__extends(UninitializedContextError, _super);
    function UninitializedContextError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return UninitializedContextError;
}(ShopifyError));
error.UninitializedContextError = UninitializedContextError;
var PrivateAppError = /** @class */ (function (_super) {
    tslib_1$n.__extends(PrivateAppError, _super);
    function PrivateAppError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return PrivateAppError;
}(ShopifyError));
error.PrivateAppError = PrivateAppError;
var HttpRequestError = /** @class */ (function (_super) {
    tslib_1$n.__extends(HttpRequestError, _super);
    function HttpRequestError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpRequestError;
}(ShopifyError));
error.HttpRequestError = HttpRequestError;
var HttpMaxRetriesError = /** @class */ (function (_super) {
    tslib_1$n.__extends(HttpMaxRetriesError, _super);
    function HttpMaxRetriesError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpMaxRetriesError;
}(ShopifyError));
error.HttpMaxRetriesError = HttpMaxRetriesError;
var HttpResponseError = /** @class */ (function (_super) {
    tslib_1$n.__extends(HttpResponseError, _super);
...
error.HttpResponseError = HttpResponseError;
var HttpRetriableError = /** @class */ (function (_super) {
    tslib_1$n.__extends(HttpRetriableError, _super);
    function HttpRetriableError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpRetriableError;
}(ShopifyError));
error.HttpRetriableError = HttpRetriableError;
var HttpInternalError = /** @class */ (function (_super) {
    tslib_1$n.__extends(HttpInternalError, _super);
    function HttpInternalError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return HttpInternalError;
}(HttpRetriableError));
error.HttpInternalError = HttpInternalError;
var HttpThrottlingError = /** @class */ (function (_super) {
    tslib_1$n.__extends(HttpThrottlingError, _super);
...
error.HttpThrottlingError = HttpThrottlingError;
var RestResourceError = /** @class */ (function (_super) {
    tslib_1$n.__extends(RestResourceError, _super);
    function RestResourceError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return RestResourceError;
}(ShopifyError));
error.RestResourceError = RestResourceError;
var RestResourceRequestError = /** @class */ (function (_super) {
    tslib_1$n.__extends(RestResourceRequestError, _super);
    function RestResourceRequestError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return RestResourceRequestError;
}(HttpResponseError));
error.RestResourceRequestError = RestResourceRequestError;
var InvalidOAuthError = /** @class */ (function (_super) {
    tslib_1$n.__extends(InvalidOAuthError, _super);
    function InvalidOAuthError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InvalidOAuthError;
}(ShopifyError));
error.InvalidOAuthError = InvalidOAuthError;
var SessionNotFound = /** @class */ (function (_super) {
    tslib_1$n.__extends(SessionNotFound, _super);
...
var CookieNotFound = /** @class */ (function (_super) {
    tslib_1$n.__extends(CookieNotFound, _super);
    function CookieNotFound() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return CookieNotFound;
}(ShopifyError));
error.CookieNotFound = CookieNotFound;
var InvalidSession = /** @class */ (function (_super) {
    tslib_1$n.__extends(InvalidSession, _super);
...
memory.MemorySessionStorage = MemorySessionStorage;
...
Object.defineProperty(scopes, "__esModule", { value: true });
scopes.AuthScopes = void 0;
...
var AuthScopes = /** @class */ (function () {
    function AuthScopes(scopes) {
        ...
        this.compressedScopes = new Set(tslib_1$l.__spread(scopeSet).filter(function (x) { return !impliedSet.has(x); }));
        this.expandedScopes = new Set(tslib_1$l.__spread(scopeSet, impliedSet));
    }
    ...
    AuthScopes.prototype.toArray = function () {
        return tslib_1$l.__spread(this.compressedScopes);
    };
...
var ShopifyErrors$c = tslib_1$k.__importStar(error);
var memory_1 = memory;
var base_types_1$5 = baseTypes;
var scopes_1 = scopes;
var Context = {
    API_KEY: '',
    API_SECRET_KEY: '',
    ...
    HOST_NAME: '',
    API_VERSION: base_types_1$5.ApiVersion.Unstable,
    ...
    initialize: function (params) {
        ...
        if (missing.length) {
            throw new ShopifyErrors$c.ShopifyError("Cannot initialize Shopify API Library. Missing values for: " + missing.join(', '));
        }
    ...
    throwIfUninitialized: function () {
        if (!this.API_KEY || this.API_KEY.length === 0) {
            throw new ShopifyErrors$c.UninitializedContextError('Context has not been properly initialized. Please call the .initialize() method to setup your app context object.');
        }
    },
    throwIfPrivateApp: function (message) {
        if (Context.IS_PRIVATE_APP) {
            throw new ShopifyErrors$c.PrivateAppError(message);
        }
    },
};
...
var _crypto$2 = _interopRequireDefault$b(require$$1__default["default"]);
...
var _default$b = validate$1;
validate$2.default = _default$b;
...
var _validate$2 = _interopRequireDefault$9(validate$2);
...
var _validate$1 = _interopRequireDefault$7(validate$2);
...
var _crypto$1 = _interopRequireDefault$5(require$$1__default["default"]);
...
var _crypto = _interopRequireDefault$2(require$$1__default["default"]);
...
var _validate = _interopRequireDefault(validate$2);
...
var crypto$2 = require$$1__default["default"];

function bufferEqual$1(a, b) {
...
function timeSafeCompare(a, b) {
  ...
  return bufferEqual$1(ah, bh) && a === b;
}
...
var compare = lib$2;
var crypto$1 = require$$1__default["default"];
...
Object.defineProperty(nonce$1, "__esModule", { value: true });
var tslib_1$j = require$$0;
var crypto_1$4 = tslib_1$j.__importDefault(require$$1__default["default"]);
function nonce() {
    var length = 15;
    var bytes = crypto_1$4.default.randomBytes(length);
    var nonce = bytes
        .map(function (byte) {
        return byte % 10;
    })
...
nonce$1.default = nonce;

var hmacValidator = {};

var safeCompare$1 = {};

Object.defineProperty(safeCompare$1, "__esModule", { value: true });
var tslib_1$i = require$$0;
var crypto_1$3 = tslib_1$i.__importDefault(require$$1__default["default"]);
var ShopifyErrors$b = tslib_1$i.__importStar(error);
/**
...
function safeCompare(strA, strB) {
    if (typeof strA === typeof strB) {
        ...
        if (buffA.length === buffB.length) {
            return crypto_1$3.default.timingSafeEqual(buffA, buffB);
        }
    }
    else {
        throw new ShopifyErrors$b.SafeCompareError("Mismatched data types provided: " + typeof strA + " and " + typeof strB);
    }
    return false;
}
safeCompare$1.default = safeCompare;

Object.defineProperty(hmacValidator, "__esModule", { value: true });
hmacValidator.generateLocalHmac = hmacValidator.stringifyQuery = void 0;
var tslib_1$h = require$$0;
var crypto_1$2 = tslib_1$h.__importDefault(require$$1__default["default"]);
var querystring_1$4 = tslib_1$h.__importDefault(querystring$1);
var ShopifyErrors$a = tslib_1$h.__importStar(error);
var context_1$f = context;
var safe_compare_1$2 = tslib_1$h.__importDefault(safeCompare$1);
function stringifyQuery(query) {
    var orderedObj = Object.keys(query)
        .sort(function (val1, val2) { return val1.localeCompare(val2); })
        .reduce(function (obj, key) {
        var _a;
        return (tslib_1$h.__assign(tslib_1$h.__assign({}, obj), (_a = {}, _a[key] = query[key], _a)));
    }, {});
    return querystring_1$4.default.stringify(orderedObj);
}
hmacValidator.stringifyQuery = stringifyQuery;
function generateLocalHmac(_a) {
    var code = _a.code, timestamp = _a.timestamp, state = _a.state, shop = _a.shop, host = _a.host;
    var queryString = stringifyQuery(tslib_1$h.__assign({ code: code,
        timestamp: timestamp,
        state: state,
        shop: shop }, (host && { host: host })));
    return crypto_1$2.default
        .createHmac('sha256', context_1$f.Context.API_SECRET_KEY)
        .update(queryString)
        .digest('hex');
}
hmacValidator.generateLocalHmac = generateLocalHmac;
/**
...
function validateHmac(query) {
    if (!query.hmac) {
        throw new ShopifyErrors$a.InvalidHmacError('Query does not contain an HMAC value.');
    }
    var hmac = query.hmac;
    var localHmac = generateLocalHmac(query);
    return safe_compare_1$2.default(hmac, localHmac);
}
hmacValidator.default = validateHmac;

var shopValidator = {};

Object.defineProperty(shopValidator, "__esModule", { value: true });
/**
...
shopValidator.default = validateShop;

var decodeSessionToken$1 = {};
...
var util$5 = require$$5__default["default"];
...
/*jshint node:true */
var Buffer$6 = require$$0__default$1["default"].Buffer; // browserify
...
var util$4 = require$$5__default["default"];
...
Object.defineProperty(decodeSessionToken$1, "__esModule", { value: true });
decodeSessionToken$1.decodeSessionToken = void 0;
var tslib_1$g = require$$0;
var jsonwebtoken_1 = tslib_1$g.__importDefault(jsonwebtoken);
var context_1$e = context;
var ShopifyErrors$9 = tslib_1$g.__importStar(error);
var shop_validator_1$3 = tslib_1$g.__importDefault(shopValidator);
...
function decodeSessionToken(token) {
    var payload;
    try {
        payload = jsonwebtoken_1.default.verify(token, context_1$e.Context.API_SECRET_KEY, {
            algorithms: ['HS256'],
            clockTolerance: JWT_PERMITTED_CLOCK_TOLERANCE,
        });
    }
    catch (error) {
        throw new ShopifyErrors$9.InvalidJwtError("Failed to parse session token '" + token + "': " + error.message);
    }
    // The exp and nbf fields are validated by the JWT library
    if (payload.aud !== context_1$e.Context.API_KEY) {
        throw new ShopifyErrors$9.InvalidJwtError('Session token had invalid API key');
    }
    if (!shop_validator_1$3.default(payload.dest.replace(/^https:\/\//, ''))) {
        throw new ShopifyErrors$9.InvalidJwtError('Session token had invalid shop');
    }
    return payload;
}
decodeSessionToken$1.decodeSessionToken = decodeSessionToken;
decodeSessionToken$1.default = decodeSessionToken;
...
var Session = /** @class */ (function () {
    ...
    Session.prototype.isActive = function () {
        var scopesUnchanged = context_1$d.Context.SCOPES.equals(this.scope);
        if (scopesUnchanged &&
            this.accessToken &&
...
Object.defineProperty(custom, "__esModule", { value: true });
custom.CustomSessionStorage = void 0;
var tslib_1$f = require$$0;
var session_1$1 = session;
var ShopifyErrors$8 = tslib_1$f.__importStar(error);
var CustomSessionStorage = /** @class */ (function () {
    ...
    CustomSessionStorage.prototype.storeSession = function (session) {
        return tslib_1$f.__awaiter(this, void 0, void 0, function () {
            var error_1;
            return tslib_1$f.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new ShopifyErrors$8.SessionStorageError("CustomSessionStorage failed to store a session. Error Details: " + error_1);
        ...
        return tslib_1$f.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1$f.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        throw new ShopifyErrors$8.SessionStorageError("CustomSessionStorage failed to load a session. Error Details: " + error_2);
                    case 3:
                        if (result) {
                            if (result instanceof session_1$1.Session) {
                                ...
                                session = new session_1$1.Session(result.id, result.shop, result.state, result.isOnline);
                                session = tslib_1$f.__assign(tslib_1$f.__assign({}, session), result);
                                ...
                                throw new ShopifyErrors$8.SessionStorageError("Expected return to be instanceof Session, but received instanceof " + result.constructor.name + ".");
                            }
                        }
                        else {
        ...
        return tslib_1$f.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1$f.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_3 = _a.sent();
                        throw new ShopifyErrors$8.SessionStorageError("CustomSessionStorage failed to delete a session. Error Details: " + error_3);
                    case 3: return [2 /*return*/];
                }
            });
        });
...
custom.CustomSessionStorage = CustomSessionStorage;
...
(function (module) {
const punycode = punycode$2.exports;
const tr46$1 = tr46;
...
network$1.getResponseType = getResponseType;
network$1.nonceSource = nonceSource;
network$1.hashSource = hashSource;
network$1.noCache = network$1.CacheControl = network$1.ResponseType = network$1.HashAlgorithm = network$1.SriAsset = network$1.SpecialSource = network$1.CspSandboxAllow = network$1.CspDirective = network$1.Header = network$1.StatusCode = network$1.Method = void 0;
let Method;
network$1.Method = Method;
...
})(Method || (network$1.Method = Method = {}));

let StatusCode;
network$1.StatusCode = StatusCode;
...
})(StatusCode || (network$1.StatusCode = StatusCode = {}));

let Header;
network$1.Header = Header;
...
})(Header || (network$1.Header = Header = {}));

let CspDirective;
network$1.CspDirective = CspDirective;
...
})(CspDirective || (network$1.CspDirective = CspDirective = {}));

let CspSandboxAllow;
network$1.CspSandboxAllow = CspSandboxAllow;
...
})(CspSandboxAllow || (network$1.CspSandboxAllow = CspSandboxAllow = {}));

let SpecialSource;
network$1.SpecialSource = SpecialSource;
...
})(SpecialSource || (network$1.SpecialSource = SpecialSource = {}));

let SriAsset;
network$1.SriAsset = SriAsset;

(function (SriAsset) {
  SriAsset["Script"] = "script";
  SriAsset["Style"] = "style";
})(SriAsset || (network$1.SriAsset = SriAsset = {}));

let HashAlgorithm;
network$1.HashAlgorithm = HashAlgorithm;

(function (HashAlgorithm) {
  HashAlgorithm["Sha256"] = "sha256";
  HashAlgorithm["Sha384"] = "sha384";
  HashAlgorithm["Sha512"] = "sha512";
})(HashAlgorithm || (network$1.HashAlgorithm = HashAlgorithm = {}));

let ResponseType;
network$1.ResponseType = ResponseType;
...
})(ResponseType || (network$1.ResponseType = ResponseType = {}));
...
let CacheControl;
network$1.CacheControl = CacheControl;
...
version.SHOPIFY_API_LIBRARY_VERSION = void 0;
version.SHOPIFY_API_LIBRARY_VERSION = '2.1.0';

var processedQuery = {};

Object.defineProperty(processedQuery, "__esModule", { value: true });
var tslib_1$e = require$$0;
var querystring_1$3 = tslib_1$e.__importDefault(querystring$1);
var ProcessedQuery = /** @class */ (function () {
    ...
    ProcessedQuery.prototype.putAll = function (keyValuePairs) {
        ...
        Object.entries(keyValuePairs).forEach(function (_a) {
            var _b = tslib_1$e.__read(_a, 2), key = _b[0], value = _b[1];
    ...
    ProcessedQuery.prototype.putObject = function (key, value) {
        ...
        Object.entries(value).forEach(function (_a) {
            var _b = tslib_1$e.__read(_a, 2), entry = _b[0], entryValue = _b[1];
    ...
    ProcessedQuery.prototype.stringify = function () {
        return "?" + querystring_1$3.default.stringify(this.processedQuery);
    };
    return ProcessedQuery;
}());
processedQuery.default = ProcessedQuery;
...
http_client.HttpClient = void 0;
var tslib_1$d = require$$0;
var querystring_1$2 = tslib_1$d.__importDefault(querystring$1);
var crypto_1$1 = tslib_1$d.__importDefault(require$$1__default["default"]);
var fs_1 = tslib_1$d.__importDefault(fs__default["default"]);
var node_fetch_1 = tslib_1$d.__importDefault(require$$4);
var network_1$1 = network;
var ShopifyErrors$7 = tslib_1$d.__importStar(error);
var version_1 = version;
var shop_validator_1$2 = tslib_1$d.__importDefault(shopValidator);
var context_1$c = context;
var processed_query_1 = tslib_1$d.__importDefault(processedQuery);
var types_1$3 = types$9;
var HttpClient = /** @class */ (function () {
    function HttpClient(domain) {
        this.domain = domain;
        this.LOGGED_DEPRECATIONS = {};
        if (!shop_validator_1$2.default(domain)) {
            throw new ShopifyErrors$7.InvalidShopError("Domain " + domain + " is not valid");
        }
        this.domain = domain;
    }
    /**
    ...
    HttpClient.prototype.get = function (params) {
        return tslib_1$d.__awaiter(this, void 0, void 0, function () {
            return tslib_1$d.__generator(this, function (_a) {
                return [2 /*return*/, this.request(tslib_1$d.__assign({ method: network_1$1.Method.Get }, params))];
            });
        });
    };
    /**
    ...
    HttpClient.prototype.post = function (params) {
        return tslib_1$d.__awaiter(this, void 0, void 0, function () {
            return tslib_1$d.__generator(this, function (_a) {
                return [2 /*return*/, this.request(tslib_1$d.__assign({ method: network_1$1.Method.Post }, params))];
            });
        });
    };
    /**
    ...
    HttpClient.prototype.put = function (params) {
        return tslib_1$d.__awaiter(this, void 0, void 0, function () {
            return tslib_1$d.__generator(this, function (_a) {
                return [2 /*return*/, this.request(tslib_1$d.__assign({ method: network_1$1.Method.Put }, params))];
            });
        });
    };
    /**
    ...
    HttpClient.prototype.delete = function (params) {
        return tslib_1$d.__awaiter(this, void 0, void 0, function () {
            return tslib_1$d.__generator(this, function (_a) {
                return [2 /*return*/, this.request(tslib_1$d.__assign({ method: network_1$1.Method.Delete }, params))];
            });
        });
    };
    HttpClient.prototype.request = function (params) {
        return tslib_1$d.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1$d.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        maxTries = params.tries ? params.tries : 1;
                        if (maxTries <= 0) {
                            throw new ShopifyErrors$7.HttpRequestError("Number of tries must be >= 0, got " + maxTries);
                        }
                        userAgent = "Shopify API Library v" + version_1.SHOPIFY_API_LIBRARY_VERSION + " | Node " + process.version;
                        if (context_1$c.Context.USER_AGENT_PREFIX) {
                            userAgent = context_1$c.Context.USER_AGENT_PREFIX + " | " + userAgent;
                        }
                        ...
                        headers = tslib_1$d.__assign(tslib_1$d.__assign({}, params.extraHeaders), { 'User-Agent': userAgent });
                        body = null;
                        if (params.method === network_1$1.Method.Post || params.method === network_1$1.Method.Put) {
                            _a = params, type = _a.type, data = _a.data;
                            if (data) {
                                switch (type) {
                                    case types_1$3.DataType.JSON:
                                        body = typeof data === 'string' ? data : JSON.stringify(data);
                                        break;
                                    case types_1$3.DataType.URLEncoded:
                                        body =
                                            typeof data === 'string'
                                                ? data
                                                : querystring_1$2.default.stringify(data);
                                        break;
                                    case types_1$3.DataType.GraphQL:
                                        body = data;
                                        break;
                                }
                                headers = tslib_1$d.__assign({ 'Content-Type': type, 'Content-Length': Buffer.byteLength(body) }, params.extraHeaders);
                            }
                        }
                    ...
                    case 4:
                        error_1 = _b.sent();
                        tries++;
                        if (!(error_1 instanceof ShopifyErrors$7.HttpRetriableError)) return [3 /*break*/, 7];
                        if (!(tries < maxTries)) return [3 /*break*/, 6];
                        waitTime = HttpClient.RETRY_WAIT_TIME;
                        if (error_1 instanceof ShopifyErrors$7.HttpThrottlingError &&
                            error_1.retryAfter) {
                    ...
                    case 6:
                        ...
                        if (maxTries > 1) {
                            throw new ShopifyErrors$7.HttpMaxRetriesError("Exceeded maximum retry count of " + maxTries + ". Last message: " + error_1.message);
                        }
                        _b.label = 7;
                    case 7: 
                    ...
                    /* istanbul ignore next */
                    throw new ShopifyErrors$7.ShopifyError("Unexpected flow, reached maximum HTTP tries but did not throw an error");
                }
            });
        });
    };
        ...
        return tslib_1$d.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1$d.__generator(this, function (_a) {
                return [2 /*return*/, node_fetch_1.default(url, options)
                        .then(function (response) { return tslib_1$d.__awaiter(_this, void 0, void 0, function () {
                                    ...
                                    if (response.ok) {
                                        if (response.headers &&
                                            ...
                                            if (!Object.keys(this.LOGGED_DEPRECATIONS).includes(depHash) ||
                                                ...
                                                if (context_1$c.Context.LOG_FILE) {
                                                    stack = new Error().stack;
                                                    log = "API Deprecation Notice " + new Date().toLocaleString() + " : " + JSON.stringify(deprecation) + "\n    Stack Trace: " + stack + "\n";
                                                    fs_1.default.writeFileSync(context_1$c.Context.LOG_FILE, log, {
                                                        flag: 'a',
                                                        encoding: 'utf-8',
                                                    });
                                                }
                                        ...
                                        errorMessage = errorMessages.length
                                            ...
                                            : '';
                                        switch (true) {
                                            case response.status === network_1$1.StatusCode.TooManyRequests: {
                                                retryAfter = response.headers.get('Retry-After');
                                                throw new ShopifyErrors$7.HttpThrottlingError("Shopify is throttling requests" + errorMessage, retryAfter ? parseFloat(retryAfter) : undefined);
                                            }
                                            case response.status >= network_1$1.StatusCode.InternalServerError:
                                                throw new ShopifyErrors$7.HttpInternalError("Shopify internal error" + errorMessage);
                                            default:
                                                throw new ShopifyErrors$7.HttpResponseError("Received an error response (" + response.status + " " + response.statusText + ") from Shopify" + errorMessage, response.status, response.statusText);
                                        }
                                    }
                            }
                        });
                        ...
                        if (error instanceof ShopifyErrors$7.ShopifyError) {
                            throw error;
                        }
                        else {
                            throw new ShopifyErrors$7.HttpRequestError("Failed to make Shopify HTTP request: " + error);
                        }
                    })];
            });
        });
...
oauth.ShopifyOAuth = void 0;
var tslib_1$c = require$$0;
var querystring_1$1 = tslib_1$c.__importDefault(querystring$1);
var uuid_1 = dist;
var cookies_1 = tslib_1$c.__importDefault(cookies);
var context_1$b = context;
var nonce_1$1 = tslib_1$c.__importDefault(nonce$1);
var hmac_validator_1$1 = tslib_1$c.__importDefault(hmacValidator);
var shop_validator_1$1 = tslib_1$c.__importDefault(shopValidator);
var safe_compare_1$1 = tslib_1$c.__importDefault(safeCompare$1);
var decode_session_token_1$1 = tslib_1$c.__importDefault(decodeSessionToken$1);
var session_1 = session$1;
var http_client_1$2 = http_client;
var types_1$2 = types$9;
var ShopifyErrors$6 = tslib_1$c.__importStar(error);
var ShopifyOAuth = {
    ...
    beginAuth: function (request, response, shop, redirectPath, isOnline) {
        ...
        return tslib_1$c.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1$c.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        context_1$b.Context.throwIfUninitialized();
                        context_1$b.Context.throwIfPrivateApp('Cannot perform OAuth for private apps');
                        cookies = new cookies_1.default(request, response, {
                            keys: [context_1$b.Context.API_SECRET_KEY],
                            secure: true,
                        });
                        state = nonce_1$1.default();
                        session = new session_1.Session(isOnline ? uuid_1.v4() : this.getOfflineSessionId(shop), shop, state, isOnline);
                        return [4 /*yield*/, context_1$b.Context.SESSION_STORAGE.storeSession(session)];
                    case 1:
                        sessionStored = _a.sent();
                        if (!sessionStored) {
                            throw new ShopifyErrors$6.SessionStorageError('OAuth Session could not be saved. Please check your session storage functionality.');
                        }
                        ...
                        query = {
                            client_id: context_1$b.Context.API_KEY,
                            scope: context_1$b.Context.SCOPES.toString(),
                            redirect_uri: "https://" + context_1$b.Context.HOST_NAME + redirectPath,
                            state: state,
                            'grant_options[]': isOnline ? 'per-user' : '',
                        };
                        queryString = querystring_1$1.default.stringify(query);
            ...
            return tslib_1$c.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!sessionCookie) {
                            throw new ShopifyErrors$6.CookieNotFound("Cannot complete OAuth process. Could not find an OAuth cookie for shop url: " + query.shop);
                        }
                        return [4 /*yield*/, context_1$b.Context.SESSION_STORAGE.loadSession(sessionCookie)];
                    case 1:
                        currentSession = _a.sent();
                        if (!currentSession) {
                            throw new ShopifyErrors$6.SessionNotFound("Cannot complete OAuth process. No session found for the specified shop url: " + query.shop);
                        }
                        if (!validQuery(query, currentSession)) {
                            throw new ShopifyErrors$6.InvalidOAuthError('Invalid OAuth callback.');
                        }
                        body = {
                            client_id: context_1$b.Context.API_KEY,
                            client_secret: context_1$b.Context.API_SECRET_KEY,
                            code: query.code,
                        };
                        postParams = {
                            path: '/admin/oauth/access_token',
                            type: types_1$2.DataType.JSON,
                            data: body,
                        };
                        client = new http_client_1$2.HttpClient(currentSession.shop);
                    ...
                    case 2:
                        ...
                        access_token = responseBody.access_token, scope = responseBody.scope, rest = tslib_1$c.__rest(responseBody, ["access_token", "scope"]);
                        ...
                        if (!context_1$b.Context.IS_EMBEDDED_APP) return [3 /*break*/, 4];
                        ...
                        return [4 /*yield*/, context_1$b.Context.SESSION_STORAGE.deleteSession(currentSession.id)];
                    case 3:
                        sessionDeleted = _a.sent();
                        if (!sessionDeleted) {
                            throw new ShopifyErrors$6.SessionStorageError('OAuth Session could not be deleted. Please check your session storage functionality.');
                        }
                    ...
                    case 6:
                        cookies.set(ShopifyOAuth.SESSION_COOKIE_NAME, currentSession.id, {
                            signed: true,
                            expires: context_1$b.Context.IS_EMBEDDED_APP ? new Date() : currentSession.expires,
                            sameSite: 'lax',
                            secure: true,
                        });
                        return [4 /*yield*/, context_1$b.Context.SESSION_STORAGE.storeSession(currentSession)];
                    case 7:
                        sessionStored = _a.sent();
                        if (!sessionStored) {
                            throw new ShopifyErrors$6.SessionStorageError('OAuth Session could not be saved. Please check your session storage functionality.');
    ...
    getCurrentSessionId: function (request, response, isOnline) {
        ...
        if (context_1$b.Context.IS_EMBEDDED_APP) {
            var authHeader = request.headers.authorization;
            if (authHeader) {
                var matches = authHeader.match(/^Bearer (.+)$/);
                if (!matches) {
                    throw new ShopifyErrors$6.MissingJwtTokenError('Missing Bearer token in authorization header');
                }
                var jwtPayload = decode_session_token_1$1.default(matches[1]);
...
oauth.ShopifyOAuth = ShopifyOAuth;
/**
...
function validQuery(query, session) {
    return (hmac_validator_1$1.default(query) &&
        shop_validator_1$1.default(query.shop) &&
        safe_compare_1$1.default(query.state, session.state));
}
...
var oauth_1 = oauth;
Object.defineProperty(exports, "ShopifyOAuth", { enumerable: true, get: function () { return oauth_1.ShopifyOAuth; } });
exports.default = oauth_1.ShopifyOAuth;
}(oauth$1));
...
Object.defineProperty(rest_client, "__esModule", { value: true });
rest_client.RestClient = void 0;
var tslib_1$b = require$$0;
var querystring_1 = tslib_1$b.__importDefault(querystring$1);
var context_1$a = context;
var base_types_1$4 = baseTypes;
var http_client_1$1 = http_client;
var ShopifyErrors$5 = tslib_1$b.__importStar(error);
var RestClient = /** @class */ (function (_super) {
    tslib_1$b.__extends(RestClient, _super);
    function RestClient(domain, accessToken) {
        var _this = _super.call(this, domain) || this;
        _this.accessToken = accessToken;
        if (!context_1$a.Context.IS_PRIVATE_APP && !accessToken) {
            throw new ShopifyErrors$5.MissingRequiredArgument('Missing access token when creating REST client');
        }
        return _this;
    }
    RestClient.prototype.request = function (params) {
        ...
        return tslib_1$b.__awaiter(this, void 0, void 0, function () {
            ...
            var _c, e_1, _d;
            return tslib_1$b.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        params.extraHeaders = tslib_1$b.__assign((_c = {}, _c[base_types_1$4.ShopifyHeader.AccessToken] = context_1$a.Context.IS_PRIVATE_APP
                            ? context_1$a.Context.API_SECRET_KEY
                    ...
                    case 1:
                        ...
                        if (link !== undefined) {
                            ...
                            if (link) {
                                links = link.split(', ');
                                try {
                                    for (links_1 = tslib_1$b.__values(links), links_1_1 = links_1.next(); !links_1_1.done; links_1_1 = links_1.next()) {
    ...
    RestClient.prototype.getRequestPath = function (path) {
        ...
        if (cleanPath.startsWith('/admin')) {
            ...
            return "/admin/api/" + context_1$a.Context.API_VERSION + cleanPath.replace(/\.json$/, '') + ".json";
        }
    };
    ...
    return RestClient;
}(http_client_1$1.HttpClient));
rest_client.RestClient = RestClient;

(function (exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.RestClient = void 0;
var rest_client_1 = rest_client;
...
Object.defineProperty(graphql_client, "__esModule", { value: true });
graphql_client.GraphqlClient = void 0;
var tslib_1$a = require$$0;
var error_1 = error;
var context_1$9 = context;
var base_types_1$3 = baseTypes;
var http_client_1 = http_client;
var types_1$1 = types$9;
var ShopifyErrors$4 = tslib_1$a.__importStar(error);
var GraphqlClient = /** @class */ (function () {
    function GraphqlClient(domain, accessToken) {
        this.domain = domain;
        this.accessToken = accessToken;
        this.baseApiPath = '/admin/api';
        if (!context_1$9.Context.IS_PRIVATE_APP && !accessToken) {
            throw new ShopifyErrors$4.MissingRequiredArgument('Missing access token when creating GraphQL client');
        }
    ...
    GraphqlClient.prototype.query = function (params) {
        return tslib_1$a.__awaiter(this, void 0, void 0, function () {
            ...
            var _a;
            return tslib_1$a.__generator(this, function (_b) {
                if (params.data.length === 0) {
                    throw new error_1.MissingRequiredArgument('Query missing.');
                }
                accessTokenHeader = this.getAccessTokenHeader();
                params.extraHeaders = tslib_1$a.__assign((_a = {}, _a[accessTokenHeader.header] = accessTokenHeader.value, _a), params.extraHeaders);
                path = this.baseApiPath + "/" + context_1$9.Context.API_VERSION + "/graphql.json";
                if (typeof params.data === 'object') {
                    dataType = types_1$1.DataType.JSON;
                }
                else {
                    dataType = types_1$1.DataType.GraphQL;
                }
                return [2 /*return*/, this.client.post(tslib_1$a.__assign({ path: path, type: dataType }, params))];
            });
        });
    };
    GraphqlClient.prototype.getAccessTokenHeader = function () {
        return {
            header: base_types_1$3.ShopifyHeader.AccessToken,
            value: context_1$9.Context.IS_PRIVATE_APP
                ? context_1$9.Context.API_SECRET_KEY
                : this.accessToken,
        };
    };
...
var graphql_client_1 = graphql_client;
...
var storefront_client = {};

Object.defineProperty(storefront_client, "__esModule", { value: true });
storefront_client.StorefrontClient = void 0;
var tslib_1$9 = require$$0;
var context_1$8 = context;
var base_types_1$2 = baseTypes;
var graphql_client_1$1 = graphql_client;
var StorefrontClient = /** @class */ (function (_super) {
    tslib_1$9.__extends(StorefrontClient, _super);
    ...
    StorefrontClient.prototype.getAccessTokenHeader = function () {
        return {
            header: base_types_1$2.ShopifyHeader.StorefrontAccessToken,
            value: (context_1$8.Context.IS_PRIVATE_APP
                ? context_1$8.Context.PRIVATE_APP_STOREFRONT_ACCESS_TOKEN || this.accessToken
                : this.accessToken),
        };
    };
    return StorefrontClient;
}(graphql_client_1$1.GraphqlClient));
storefront_client.StorefrontClient = StorefrontClient;

Object.defineProperty(clients, "__esModule", { value: true });
clients.ShopifyClients = void 0;
var rest_1$1 = rest;
var graphql_1$2 = graphql;
var storefront_client_1 = storefront_client;
var ShopifyClients = {
    Rest: rest_1$1.RestClient,
    Graphql: graphql_1$2.GraphqlClient,
    Storefront: storefront_client_1.StorefrontClient,
};
clients.ShopifyClients = ShopifyClients;
clients.default = ShopifyClients;

var utils = {};

var deleteCurrentSession$1 = {};

Object.defineProperty(deleteCurrentSession$1, "__esModule", { value: true });
var tslib_1$8 = require$$0;
var context_1$7 = context;
var oauth_1$3 = oauth;
var ShopifyErrors$3 = tslib_1$8.__importStar(error);
/**
...
function deleteCurrentSession(request, response, isOnline) {
    ...
    return tslib_1$8.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1$8.__generator(this, function (_a) {
            context_1$7.Context.throwIfUninitialized();
            sessionId = oauth_1$3.ShopifyOAuth.getCurrentSessionId(request, response, isOnline);
            if (!sessionId) {
                throw new ShopifyErrors$3.SessionNotFound('No active session found.');
            }
            return [2 /*return*/, context_1$7.Context.SESSION_STORAGE.deleteSession(sessionId)];
        });
    });
}
deleteCurrentSession$1.default = deleteCurrentSession;

var deleteOfflineSession$1 = {};

Object.defineProperty(deleteOfflineSession$1, "__esModule", { value: true });
var tslib_1$7 = require$$0;
var context_1$6 = context;
var oauth_1$2 = tslib_1$7.__importDefault(oauth$1);
/**
...
function deleteOfflineSession(shop) {
    return tslib_1$7.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1$7.__generator(this, function (_a) {
            context_1$6.Context.throwIfUninitialized();
            sessionId = oauth_1$2.default.getOfflineSessionId(shop);
            return [2 /*return*/, context_1$6.Context.SESSION_STORAGE.deleteSession(sessionId)];
        });
    });
}
deleteOfflineSession$1.default = deleteOfflineSession;

var loadCurrentSession$1 = {};

Object.defineProperty(loadCurrentSession$1, "__esModule", { value: true });
...
function loadCurrentSession(request, response, isOnline) {
    ...
    return tslib_1$6.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1$6.__generator(this, function (_a) {
            context_1$5.Context.throwIfUninitialized();
            sessionId = oauth_1$1.ShopifyOAuth.getCurrentSessionId(request, response, isOnline);
            if (!sessionId) {
                return [2 /*return*/, Promise.resolve(undefined)];
            }
            return [2 /*return*/, context_1$5.Context.SESSION_STORAGE.loadSession(sessionId)];
        });
    });
}
loadCurrentSession$1.default = loadCurrentSession;

var loadOfflineSession$1 = {};

Object.defineProperty(loadOfflineSession$1, "__esModule", { value: true });
var tslib_1$5 = require$$0;
var context_1$4 = context;
var oauth_1 = tslib_1$5.__importDefault(oauth$1);
/**
...
function loadOfflineSession(shop, includeExpired) {
    ...
    return tslib_1$5.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1$5.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    context_1$4.Context.throwIfUninitialized();
                    sessionId = oauth_1.default.getOfflineSessionId(shop);
                    return [4 /*yield*/, context_1$4.Context.SESSION_STORAGE.loadSession(sessionId)];
                case 1:
                    session = _a.sent();
                    now = new Date();
                    if (session &&
...
loadOfflineSession$1.default = loadOfflineSession;

var graphql_proxy = {};

Object.defineProperty(graphql_proxy, "__esModule", { value: true });
var tslib_1$4 = require$$0;
var graphql_1$1 = graphql;
var ShopifyErrors$2 = tslib_1$4.__importStar(error);
var load_current_session_1$2 = tslib_1$4.__importDefault(loadCurrentSession$1);
function graphqlProxy(userReq, userRes) {
    return tslib_1$4.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1$4.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, load_current_session_1$2.default(userReq, userRes)];
                case 1:
                    session = _a.sent();
                    if (!session) {
                        throw new ShopifyErrors$2.SessionNotFound('Cannot proxy query. No session found.');
                    }
                    else if (!session.accessToken) {
                        throw new ShopifyErrors$2.InvalidSession('Cannot proxy query. Session not authenticated.');
                    }
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            userReq.on('end', function () { return tslib_1$4.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib_1$4.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            client = new graphql_1$1.GraphqlClient(shopName, token);
...
graphql_proxy.default = graphqlProxy;

var storeSession$1 = {};

Object.defineProperty(storeSession$1, "__esModule", { value: true });
...
function storeSession(session) {
    return tslib_1$3.__awaiter(this, void 0, void 0, function () {
        return tslib_1$3.__generator(this, function (_a) {
            context_1$3.Context.throwIfUninitialized();
            return [2 /*return*/, context_1$3.Context.SESSION_STORAGE.storeSession(session)];
        });
    });
}
storeSession$1.default = storeSession;

var versionCompatible$1 = {};

Object.defineProperty(versionCompatible$1, "__esModule", { value: true });
var context_1$2 = context;
var base_types_1$1 = baseTypes;
/**
...
function versionCompatible(referenceVersion, currentVersion) {
    if (currentVersion === void 0) { currentVersion = context_1$2.Context.API_VERSION; }
    // Return true if not using a dated version
    if (currentVersion === base_types_1$1.ApiVersion.Unstable) {
        return true;
    }
...
versionCompatible$1.default = versionCompatible;

var withSession$1 = {};

Object.defineProperty(withSession$1, "__esModule", { value: true });
var tslib_1$2 = require$$0;
var ShopifyErrors$1 = tslib_1$2.__importStar(error);
var graphql_1 = graphql;
var rest_1 = rest;
var context_1$1 = context;
var load_offline_session_1$1 = tslib_1$2.__importDefault(loadOfflineSession$1);
var load_current_session_1$1 = tslib_1$2.__importDefault(loadCurrentSession$1);
function withSession(_a) {
    ...
    return tslib_1$2.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1$2.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    context_1$1.Context.throwIfUninitialized();
                    if (!isOnline) return [3 /*break*/, 2];
                    if (!req || !res) {
                        throw new ShopifyErrors$1.MissingRequiredArgument('Please pass in both the "request" and "response" objects.');
                    }
                    return [4 /*yield*/, load_current_session_1$1.default(req, res)];
                case 1:
                    session = _b.sent();
                    return [3 /*break*/, 4];
                case 2:
                    if (!shop) {
                        throw new ShopifyErrors$1.MissingRequiredArgument('Please pass in a value for "shop"');
                    }
                    return [4 /*yield*/, load_offline_session_1$1.default(shop)];
                case 3:
                    session = _b.sent();
                    _b.label = 4;
                case 4:
                    if (!session) {
                        throw new ShopifyErrors$1.SessionNotFound('No session found.');
                    }
                    else if (!session.accessToken) {
                        throw new ShopifyErrors$1.InvalidSession('Requested session does not contain an accessToken.');
                    }
                    switch (clientType) {
                        case 'rest':
                        ...
                        default:
                            throw new ShopifyErrors$1.UnsupportedClientType("\"" + clientType + "\" is an unsupported clientType. Please use \"rest\" or \"graphql\".");
                    }
            }
        });
    });
}
withSession$1.default = withSession;

Object.defineProperty(utils, "__esModule", { value: true });
var tslib_1$1 = require$$0;
var decode_session_token_1 = tslib_1$1.__importDefault(decodeSessionToken$1);
var delete_current_session_1 = tslib_1$1.__importDefault(deleteCurrentSession$1);
var delete_offline_session_1 = tslib_1$1.__importDefault(deleteOfflineSession$1);
var load_current_session_1 = tslib_1$1.__importDefault(loadCurrentSession$1);
var load_offline_session_1 = tslib_1$1.__importDefault(loadOfflineSession$1);
var nonce_1 = tslib_1$1.__importDefault(nonce$1);
var graphql_proxy_1 = tslib_1$1.__importDefault(graphql_proxy);
var safe_compare_1 = tslib_1$1.__importDefault(safeCompare$1);
var store_session_1 = tslib_1$1.__importDefault(storeSession$1);
var hmac_validator_1 = tslib_1$1.__importDefault(hmacValidator);
var shop_validator_1 = tslib_1$1.__importDefault(shopValidator);
var version_compatible_1 = tslib_1$1.__importDefault(versionCompatible$1);
var with_session_1 = tslib_1$1.__importDefault(withSession$1);
var ShopifyUtils = {
...
registry.buildQuery = registry.buildCheckQuery = registry.WebhooksRegistry = void 0;
var tslib_1 = require$$0;
var crypto_1 = require$$1__default["default"];
var network_1 = network;
var graphql_client_1 = graphql_client;
var base_types_1 = baseTypes;
var utils_1 = tslib_1.__importDefault(utils);
var context_1 = context;
var ShopifyErrors = tslib_1.__importStar(error);
var types_1 = types$8;
...
function validateDeliveryMethod(deliveryMethod) {
    if (deliveryMethod === types_1.DeliveryMethod.PubSub && !versionSupportsPubSub()) {
...
registry.buildCheckQuery = buildCheckQuery;
...
registry.buildQuery = buildQuery;
...
registry.WebhooksRegistry = WebhooksRegistry;

Object.defineProperty(webhooks, "__esModule", { value: true });
webhooks.ShopifyWebhooks = void 0;
var registry_1 = registry;
var ShopifyWebhooks = {
    Registry: registry_1.WebhooksRegistry,
};
webhooks.ShopifyWebhooks = ShopifyWebhooks;
webhooks.default = ShopifyWebhooks;
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require$$0;
tslib_1.__exportStar(types$5, exports);
tslib_1.__exportStar(types$4, exports);
}(types$6));
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require$$0;
tslib_1.__exportStar(types$9, exports);
tslib_1.__exportStar(types$2, exports);
tslib_1.__exportStar(types$1, exports);
}(types$3));
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = require$$0;
tslib_1.__exportStar(baseTypes, exports);
tslib_1.__exportStar(types$6, exports);
tslib_1.__exportStar(types$3, exports);
tslib_1.__exportStar(types, exports);
tslib_1.__exportStar(types$8, exports);
}(types$7));
...
var context_1 = context;
var ShopifyErrors = tslib_1.__importStar(error);
var oauth_1 = tslib_1.__importDefault(oauth$1);
var session_1 = tslib_1.__importDefault(session$1);
var clients_1 = tslib_1.__importDefault(clients);
var utils_1 = tslib_1.__importDefault(utils);
var webhooks_1 = tslib_1.__importDefault(webhooks);
exports.Shopify = {
...
tslib_1.__exportStar(types$7, exports);
}(dist$1));

var Shopify = /*@__PURE__*/getDefaultExportFromCjs(dist$1);

async function loadConfig(options = null) {
    let validated = false;
    const config_file = require$$0__default["default"].join(process.cwd(), 'shopify.config.js');
    if (options == null || typeof options != 'object') {
        if (!fs__default["default"].existsSync('shopify.config.js')) {
            console.error('Missing shopify.config.js — cannot init middleware');
            return;
        }
        else {
            const config = await (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(url__namespace.pathToFileURL(config_file).href);
...
function checkEnv(env) {
    ...
    const envValues = { ...{
            embedded: true,
            apiVersion: dist$1.ApiVersion.October21
        }, ...env };
    let hasError = false;
    ...
    if (envValues.apiVersion in dist$1.ApiVersion) {
...
function generateSessionStorageFromPath(sessionFile = SESSION_FILE) {
    preFsCheck(sessionFile);
    const storeCallback = async (session) => {
        let sessions = {};
        if (fs__default["default"].existsSync(sessionFile)) {
            const json = fs__default["default"].readFileSync(sessionFile).toString();
            sessions = JSON.parse(json || '{}');
        }
        sessions[session.id] = session;
        fs__default["default"].writeFileSync(sessionFile, JSON.stringify(sessions, null, '\t'));
        return true;
    };
    ...
    return new dist$1.Shopify.Session.CustomSessionStorage(storeCallback, loadCallback, deleteCallback);
}

function convertToSession(s) {
    let toReturn = new session$1.Session(s.id);
    toReturn.accessToken = s.accessToken,
        toReturn.expires = s.expires;
    toReturn.shop = s.shop;
    toReturn.scope = s.scope;
    toReturn.state = s.state;
    toReturn.isOnline = s.isOnline;
    return toReturn;
}
class Utils {
    config;
    ...
    configureSessionStorage(options) {
        if (typeof options.storage == 'object') {
            if (options.storage.customSessionStorage) {
                ...
                return generateSessionStorageFromPath(options.storage.path);
            }
        }
        else {
            return undefined;
    ...
    async setupMemory() {
        ...
        async function loader(id) {
            if (storage) {
                ...
                const vals = Object.values(storage);
                const i = vals.findIndex(s => s.id == id);
                if (i) {
                    return vals[keys[i]];
                }
            }
    ...
    async loadSession(req, res) {
        let url = req.url ? new URL(req.url) : false;
        if (!url) {
            return await Shopify.Utils.loadCurrentSession(req, res, this.isOnline);
        }
        const devIntercept = this.checkDevIntercept(getShop(url));
        if (devIntercept) {
            return devIntercept;
        }
        return;
    ...
    async handleCallback(req, res) {
        ...
        const params = checkCallbackParams(req.url ? new URL(req.url) : undefined);
        if (params) {
    ...
    async startAuth(req, res) {
        const shop = getShop(req.url ? new URL(req.url) : undefined);
        if (!shop) {
            res.writeHead(500);
...
const buildMiddleware = async (options) => {
    ...
    const Utils$1 = new Utils(config);
    await Utils$1.init();
    if (!config) {
    ...
    return async (req, res, next) => {
        ...
        console.log("Loading session for every request now");
        const session = await Utils$1.loadSession(req, res);
        console.log(session);
        let shouldContinue = true;
        if (req.url) {
            switch (url.pathname) {
                case Utils$1.paths.root:
                    shouldContinue = await Utils$1.startAuth(req, res);
                    break;
                case Utils$1.paths.session:
                    const resp = await Utils$1.loadSession(req, res);
                    if (resp) {
                    ...
                    break;
                case Utils$1.paths.callback:
                    shouldContinue = await Utils$1.handleCallback(req, res);
                    break;
                case Utils$1.paths.delete:
                    shouldContinue = await Utils$1.deleteSession(req, res);
                    break;
            }
        }
        if (shouldContinue) {
...
//# sourceMappingURL=middleware-90f11786.js.map
