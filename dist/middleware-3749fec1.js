...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-3749fec1.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-3749fec1.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
    ...
    return async (req, res, next) => {
        ...
        if (req.url) {
            switch (url.pathname) {
                ...
                default:
                    if (!session) {
                        res.writeHead(300, { 'Location': Utils$1.paths.root }).end();
                    }
                    break;
            }
        }
...
//# sourceMappingURL=middleware-3749fec1.js.map
