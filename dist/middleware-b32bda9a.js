...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-b32bda9a.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-b32bda9a.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
async function provideToken(shop, config) {
    if (shop in ACCESS_TOKENS) {
        ...
        if (config.dev) {
            console.log("Should find dev?");
            let needle = config.dev.host ? typeof config.dev.host == 'string' : 'localhost';
            console.log(needle);
            console.log(shop);
            if (shop == needle) {
...
//# sourceMappingURL=middleware-b32bda9a.js.map
