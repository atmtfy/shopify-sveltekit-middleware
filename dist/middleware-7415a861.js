...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-7415a861.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-7415a861.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
...
async function provideToken(shop, config) {
    if (shop in ACCESS_TOKENS) {
        ...
        if (config.dev) {
            ...
            console.log(`{$needle} == ${shop}: ${needle == shop}`);
            if (shop == needle) {
...
//# sourceMappingURL=middleware-7415a861.js.map
