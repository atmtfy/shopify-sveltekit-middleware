...
function isDev() {
    if (({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-81740d7b.js', document.baseURI).href)) }) && 'env' in ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('middleware-81740d7b.js', document.baseURI).href)) }) && 'mode' in undefined && undefined.mode == 'DEVELOPMENT') {
        return true;
    }
        ...
        if (req.url) {
            switch (url.pathname) {
                ...
                case pathsToWatch.token:
                    const resp = await provideToken(url.hostname, config ? config : null);
                    if (resp) {
...
//# sourceMappingURL=middleware-81740d7b.js.map
